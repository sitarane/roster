...
class SlotsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create slot" do
    assert_difference("Slot.count") do
      post slots_url, params: { slot: { comment: @slot.comment, end_time: @slot.end_time, parent_name: @slot.parent_name, school_class_id: @slot.school_class_id, start_time: @slot.start_time } }
    end
  ...
  test "should update slot" do
    patch slot_url(@slot), params: { slot: { comment: @slot.comment, end_time: @slot.end_time, parent_name: @slot.parent_name, school_class_id: @slot.school_class_id, start_time: @slot.start_time } }
