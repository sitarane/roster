...
class SchoolClassesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create school_class" do
    assert_difference("SchoolClass.count") do
      post school_classes_url, params: { school_class: { letter: @school_class.letter, year: @school_class.year } }
    end
  ...
  test "should update school_class" do
    patch school_class_url(@school_class), params: { school_class: { letter: @school_class.letter, year: @school_class.year } }
